...
void diagsrv_read_data_by_identifier(void)
{
  ...
  ld_receive_message((l_u16*)&master_req_length, (l_u8*)master_req_dat);
	...
	slave_resp_dat[0] = master_req_dat[0] + 0x20;
	slave_resp_dat[1] = master_req_dat[1];
	//slave_resp_dat[2] = master_req_dat[2]; 
	slave_resp_dat[2] = master_req_dat[2] + 0x40;
  /* process data */
  ...
  else if((master_req_dat[0] == 0x47) && (master_req_dat[1] == 0x06) && (master_req_dat[2] == 0x22))
  {
	slave_resp_dat[3] = 0x01;
	slave_resp_dat[4] = 0x42;
	slave_resp_dat[5] = 0x33;
	slave_resp_dat[6] = 0x55;
	slave_resp_dat[7] = 0x88;
	slave_resp_length = 0x08; 	
  }
